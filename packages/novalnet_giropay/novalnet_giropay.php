 ...
 * @since   11.1
 */
class plgVmPaymentnovalnet_giropay extends vmPSPlugin
{
    /**
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $this->helpers->loadNovalnetJs('novalnet_giropay', 'admin');
    }
    ...
    {
        return $this->createTableSQL('Novalnet giropay payment Table');
    }
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $this->helpers->handleSession('novalnet_giropay', 'set', 'payment_request', $data);
        $html                 = $this->helpers->buildRedirectform($data, 'novalnet_giropay');
