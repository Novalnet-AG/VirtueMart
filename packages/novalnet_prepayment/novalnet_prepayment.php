 ...
 * @subpackage novalnet_prepayment
 * @author     Novalnet AG
 ...
 * @since   11.1
 */
class plgVmPaymentnovalnet_prepayment extends vmPSPlugin
{
    /**
    ...
    function __construct(&$subject, $config)
    {
        ...
        $this->helpers->loadNovalnetJs('novalnet_prepayment', 'admin');
    }
    ...
    {
        return $this->createTableSQL('Novalnet Prepayment payment Table');
    }
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $this->helpers->handleSession('novalnet_prepayment', 'set', 'nncart', serialize($cart));
        ...
        if ($response['status'] == '100')
        {
            ...
            $this->helpers->handleSession('novalnet_prepayment', 'reset');
            $this->helpers->handleSession('novalnet_prepayment', 'clear', 'nncart');
            $cart->emptyCart();
