 ...
 * @since   11.1
 */
class plgVmPaymentnovalnet_eps extends vmPSPlugin
{
    /**
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $this->helpers->loadNovalnetJs('novalnet_eps', 'admin');
    }
    ...
    {
        return $this->createTableSQL('Novalnet eps payment Table');
    }
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $this->helpers->handleSession('novalnet_eps', 'set', 'payment_request', $data);
        $html                 = $this->helpers->buildRedirectform($data, 'novalnet_eps');
     ...
     *
     * @param   int $jplugin_id current plugin id
     *
     * @return boolean
     */
     ...
     * @param   integer $paymentCurrencyId           payment currency id
     *
     * @return boolean
     */
