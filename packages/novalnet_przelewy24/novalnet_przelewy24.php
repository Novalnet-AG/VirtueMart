 ...
 * @subpackage novalnet_przelewy24
 * @author     Novalnet AG
...
/**
 * przelewy payment class
 *
 * @package NovalnetPayments
 * @since   11.1
 */
class plgVmPaymentnovalnet_przelewy24 extends vmPSPlugin
{
    /**
    ...
    public function __construct(&$subject, $config)
    {
        ...
        $this->helpers->loadNovalnetJs('novalnet_przelewy24', 'admin');
    }
    ...
    {
        return $this->createTableSQL('Novalnet przelewy24 payment Table');
    }
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $this->helpers->handleSession('novalnet_przelewy24', 'set', 'payment_request', $data);
        $html                 = $this->helpers->buildRedirectform($data, 'novalnet_przelewy24');
     ...
     *
     * @param   string $html the success page html template
     *
     * @return boolean
     */
       ...
       if (class_exists('vmLanguage'))
        ...
        if ($response['status'] == '100')
        {
            ...
            if ($html)
            {
                ...
                $orderstatus = (in_array(array('100'), array($response['status'] ,$response['tid_status']))) ? $method->nn_callback_status : $method->nn_order_status;
